...
/***/ function(module, exports, __webpack_require__) {
	...
	// 无需在这里引入riot、jquery库，由webpack.ProvidePlugin完成
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('demo1', '<h2>{opts.title}</h2> <p>{msg}</p> <p>{data.name}</p> <ul> <li each="{item,i in items}">{i+1}. {item.name}</li> </ul>', 'demo1,[riot-tag="demo1"],[data-is="demo1"]{font-size:2rem} demo1 h2,[riot-tag="demo1"] h2,[data-is="demo1"] h2{color:red} demo1 ul,[riot-tag="demo1"] ul,[data-is="demo1"] ul{color:#999}', '', function (opts) {
		...
		_tag.msg = 'Hello,riot!';
		_tag.items = [{ id: '01', name: 'html' }, { id: '02', name: 'script' }, { id: '03', name: 'style' }];
	...
	riot.tag2('demo2', '<form id="form" action=""> <input name="name" type="text"> </form> <yield></yield> <div name="name">{data.name}</div> <yield from="html"></yield>', 'demo2,[riot-tag="demo2"],[data-is="demo2"]{font-size:2rem;color:blue}', '', function (opts) {
		var _tag = this;
		_tag.mixin(shareData); //混入共享对象
	...
	riot.tag2('mixin', '<p>mixinData: {a}, {b}</p>', '', '', function (opts) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function($) {/* Riot v2.5.0, @license MIT */
	...
	;(function (window, undefined) {
	  ...
	  * @param   { Object } options - set the propery overriding the default options
	  ...
	  /* istanbul ignore next */
	  if (typeof exports === T_OBJECT) module.exports = riot;else if ("function" === T_FUNCTION && typeof __webpack_require__(5) !== T_UNDEF) !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return riot;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('event1', '<button onclick="{click}" type="button">click here</button>', '', '', function (opts) {
		var _tag = this,
